## Add cmk-dev-tool as universal wrapper for all tools contained in this project
<!--
type: feature
scope: all
affected: all
...
Added a new `cmk-dev-tool` command that provides a unified interface to all cmk-dev-* tools.
